                ...
                <div className="relative text-xl font-thin h-full my-auto justify-center bg-gradient-to-r from-slate-950     w-1/2 text-left flex flex-col  pt-20 gap-8 ">
                    ...
                    <div className="flex justify-start gap-8">
                        ...
                        <div className="flex text-slate-900 space-x-1">
                            <div className=" bg-lavender-web-400 rounded-s-lg px-1 whitespace-normal">
                                <i className="far fa-closed-captioning"></i>{" "}
                                {episodes.sub}
                            </div>
                            {episodes.dub && <div className="bg-french-gray-600 rounded-e-lg  px-1">{episodes.dub}</div>}
                        </div>
                    </div>
                    <div className="overflow-hidden  line-clamp-3">{description}</div>
                    <div className="text-slate-900 rounded-lg bg-hookers-green-600 w-max px-4 py-2 flex items-center"><button>Watch Now{""} <i className="fa-solid fa-arrow-right align-middle"></i> </button></div>
                </div>
